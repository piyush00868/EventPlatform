...
const users = [
    { name: 'Admin User', email: 'admin@eventera.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventera.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventera.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventera.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventera.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventera.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventera.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventera.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventera.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventera.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventera.com');
        console.log('User Email:  user@eventera.com');
